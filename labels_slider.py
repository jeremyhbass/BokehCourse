...
source_original=ColumnDataSource(dict(average_grades=[1,3,7,8,10],
                             exam_grades=[2,4,6,9,8],
                             student_names=["Stephan","Helder","Riazudidn","Adam","Joe"]))

source=ColumnDataSource(dict(average_grades=[1,3,7,8,10],
                             exam_grades=[2,4,6,9,8],
                             student_names=["Stephan","Helder","Riazudidn","Adam","Joe"]))
